...
### 1. Introduction
  ...
  - This course aims to teach us how to be an efficient learner.
  - Notes should be taken throughout to solidify retention of the topics covered.
  - The course introduces a technique, memory palace, where you choose a memorable place such as your home, and imagine a scenario or story that you can link to topics to learn.
  - Apply the technique to remember the first 10 cards revealed from [a deck](https://deck.of.cards/) — it works
...
### 2. Principles
  ...
  - Shift focus from getting the best result (money, promotion) to a long-term learning mindset.
  ...
  - Choice vs chore: Shift focus on learning from **_I must_** to **_I want to_** in order to grow.
  - Use frames to change perspective. Instead of **"I can't do this"**, think **"I am improving at this"**.
  - Pareto principle: 80/20 rule — Reduce from 100% until you reach the 20% which will give 80% of the results.
  ...
  - Skill stacking: 3 approaches to career strategy:
    ...
    - **2. Value learning above all else**: A job where everyone is smarter than you > high salary.
    - **3. Gather and combine skills in a unique way.**
  ...
  - Your productivity time: Learn in the time of the day you are productive (morning).
...
- **You can avoid risk**
  ...
  - Embrace the butterflies in your stomach; they signify you are doing something worthwhile.
...
- **1. Everything is a game**
  ...
  - **Growth mindset:** Talent / intelligence aren't just gifts, they can be learned with effort and strategy.
  - **Locus of control**: To improve skills we need to accept responsibility that we control outcomes, rather than blaming external factors when things go unfavourably.
- **2. Feynman technique**
...
- **4. Efficiency trumps grit**
  ...
  - By using the right strategies and methods and learning the right topics, you are learning efficiently.
...
- **Habits**
  ...
  - Build consistency: [Don't break the chain](https://www.developgoodhabits.com/chain/)
- **System vs Goals**
