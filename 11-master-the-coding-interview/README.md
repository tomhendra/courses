...
I became interested in coding a few years ago when I was offered to build an e-commerce website for my best friend's record label, as he knew I was always into technology, and had an eye for design. I chose to use WordPress and bought a theme, but was disappointed with the built-in style limitations, but found out I could add custom CSS. I started researching, found MDN and was hooked! I launched the site (on Kinsta) just in time for a new music release, which had 100's of simultaneous downloads while the performance remained stable, which gave me a massive buzz! I was stagnating at my job at the time, and when I got paid for the site and received good feedback, I thought "wow, I could build websites for a living". So I started learning to code after work and at weekends.

A few months later the same friend passed away at 33, which made me reflect on life. My fiancée and I had a dream of moving to Spain, and realising just how short life can be, we decided to go for it. So I gave six months notice on my job, we saved hard, sold everything we owned, and moved to Spain where I could study software development full time and my partner could look for work as a teacher.

We settled in Spain, I found Kamran Ahmed's Developer Roadmap and followed it, started learning JavaScript, then React, and built my portfolio with Gatbsy. As I learned more I used the knowledge to improve my portfolio. At this point I was confident I could build JAMStack websites with a CMS powered blog and a straight 100 Lighthouse score, so I had the ability to freelance. Then I started to work on more complex projects by gaining more advanced skills from Frontend Masters and egghead.io, while writing blog posts to solidify what I learned (using the Feynman Technique).

Through these projects and posts, every day I am improving as a coder, to the point where I feel very confident that I could be a valuable asset to your team, not just now but in the years to come where I expect my abilities to grow exponentially.
