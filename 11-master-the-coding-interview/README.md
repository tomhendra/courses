...
I became interested in coding a few years ago when I was asked to build an e-commerce website for my best friend's record label, because he knew I was into computers and had an eye for design. I bought a WordPress theme which had limited style options, but found out I could add custom CSS code. So I did some research, wrote some CSS and instantly wanted to dive deeper! My job was stagnating at the time, so when I received good feedback for the website I thought "wow, maybe I could build websites for a living". So I started learning to code after work and at weekends.

A few months later that same friend passed away at 33, which made me reflect on life. My fiancée and I had a dream of moving to Spain, and realising just how short life can be, we saved hard for six months, sold everything we owned, and moved to Spain where I could study software development full time and my partner could look for work as a teacher.

We settled in Spain, I came across Kamran Ahmed's Developer Roadmap and started learning JavaScript, then React, and built my portfolio site with Gatbsy. As I learned more I improved my portfolio to the point where I was confident I could build JAMStack websites with a CMS powered blog and straight 100 Lighthouse score, so I had the ability to freelance. After that I started to work on more complex projects by gaining more advanced skills, while writing blog posts to solidify what I learned (using the Feynman Technique).

Through these projects and posts, every day I am improving as a coder, to the point where I feel confident that I could be a valuable asset to your team, not just now but in the years to come where I expect my abilities to grow exponentially.
