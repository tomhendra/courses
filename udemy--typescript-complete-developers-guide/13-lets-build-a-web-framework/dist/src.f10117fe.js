...
var axios_1 = __importDefault(require("axios")); // generic constraint 'T extends HasId' to ensure whatever data is passed to save() has an id property.
...
function (_super) {
  ...
  } // static class method to serve back preconfigured user with sub-modules inside
